const day01 = require('../exercises/day02');
...
test('getMultiplicationOfFinalPositionOfSubmarine example should return 150', () => {
    expect(day01.getMultiplicationOfFinalPositionOfSubmarine(example)).toBe(150);
})

test('getMultiplicationOfFinalPositionOfSubmarine2 example should return 900', () => {
    expect(day01.getMultiplicationOfFinalPositionOfSubmarine2(example)).toBe(900);
})
